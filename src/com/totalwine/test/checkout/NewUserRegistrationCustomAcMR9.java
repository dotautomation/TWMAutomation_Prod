...
public class NewUserRegistrationCustomAcMR9 extends Browser {
...
//	    driver.findElement(PageGlobal.SignUp).click();
	    driver.findElement(By.cssSelector("div.loggedin-wrapper.loggedin-not-wrapper > div.signinup-items > div.signup-btn > a.btn.btn-red.analyticsSignUp")).click();
	    Thread.sleep(2000);
...
//    	System.out.println("Registered Email Address: "+email);
	    ...
	    WebElement scroll = driver.findElement(By.cssSelector("#btnnuregisteration"));  
	    ...
	    js1.executeScript("arguments[0].click();", driver.findElement(By.cssSelector("#shipToStateDropdown > div > div.dropdown.inst-state > div > span > i")));        
...
//	    driver.findElement(By.cssSelector("#shipToStateDropdown > div > div.dropdown.inst-state > div > span > i")).click();
	    ...
	    WebElement scroll2 = driver.findElement(By.cssSelector("#city"));  
